...
param.N  = 18;                                      % Number of snake robot links
...
param.friction = 0;                                 % Choice of friction:   0 - Coulomb, 1 - viscous
...
% Trajectory
for i=1:param.N-1
    phi = param.alpha*sin((param.omega*t+(i-1)*param.delta));
    phi_required{i} = phi;
