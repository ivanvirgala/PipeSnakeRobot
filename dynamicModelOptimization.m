function [xDot] = dynamicModelOptimization(t,x,param,optParametre)
    %% Basic parameters
    ut      = param.ut;
    un      = param.un;
    ct      = param.ct;
    ...
    m       = param.m;
    g       = param.g;
    alfa    = optParametre(1);%param.alfa;
    omega   = optParametre(2);%param.omega;
    delta   = optParametre(3);%param.delta;
    offset  = param.offset;
    tlmic   = param.tlmic;
